...
LogConfig CameraDetBaseLogger::logConfig_ = {"CameraDetBase",
    "camera_det_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> CameraDetBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> CameraDetBaseLogger::loggerCtxMap_;
std::mutex CameraDetBaseLogger::ctxMapMutex_;
std::mutex CameraDetBaseLogger::loggerCtxMapMutex_;

void CameraDetBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void CameraDetBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void CameraDetBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* CameraDetBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String CameraDetBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> CameraDetBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel CameraDetBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode CameraDetBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig CameraDetBaseLogger::ParseLogConfig()
{
    ara::core::String filePath;
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "camera_det_base context",
...
bool CameraDetBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool CameraDetBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
