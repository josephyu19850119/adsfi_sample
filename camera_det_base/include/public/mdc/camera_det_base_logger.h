 ...
 */
#ifndef ARA_CAMERA_DET_BASE_CAMERA_DET_BASE_LOGGER_H
#define ARA_CAMERA_DET_BASE_CAMERA_DET_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class CameraDetBaseLogger {
public:
    virtual ~CameraDetBaseLogger() = default;
     ...
     * ara::camera_det_base::CameraDetBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_CAMERA_DET_BASE_CAMERA_DET_BASE_LOGGER_H */