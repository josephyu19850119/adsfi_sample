...
LogConfig CameradetectionLogger::logConfig_ = {"Cameradetection",
    "CameraDetection context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> CameradetectionLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> CameradetectionLogger::loggerCtxMap_;
std::mutex CameradetectionLogger::ctxMapMutex_;
std::mutex CameradetectionLogger::loggerCtxMapMutex_;

void CameradetectionLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void CameradetectionLogger::InitAppLogging()
{
    SetLogConfig();
...
void CameradetectionLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* CameradetectionLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String CameradetectionLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> CameradetectionLogger::GetSpecifyLogMode(
...
ara::log::LogLevel CameradetectionLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode CameradetectionLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig CameradetectionLogger::ParseLogConfig()
{
    ara::core::String filePath;
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "CameraDetection context",
...
bool CameradetectionLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool CameradetectionLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
