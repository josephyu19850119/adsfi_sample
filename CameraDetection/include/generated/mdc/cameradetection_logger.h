 ...
 */
#ifndef ARA_CAMERADETECTION_CAMERADETECTION_LOGGER_H
#define ARA_CAMERADETECTION_CAMERADETECTION_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class CameradetectionLogger {
public:
    virtual ~CameradetectionLogger() = default;
     ...
     * ara::cameradetection::CameradetectionLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_CAMERADETECTION_CAMERADETECTION_LOGGER_H */