 ...
 */
#ifndef ARA_CAMERA_TRACK_BASE_CAMERA_TRACK_BASE_LOGGER_H
#define ARA_CAMERA_TRACK_BASE_CAMERA_TRACK_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class CameraTrackBaseLogger {
public:
    virtual ~CameraTrackBaseLogger() = default;
     ...
     * ara::camera_track_base::CameraTrackBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_CAMERA_TRACK_BASE_CAMERA_TRACK_BASE_LOGGER_H */