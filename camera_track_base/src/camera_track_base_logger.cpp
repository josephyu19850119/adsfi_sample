...
LogConfig CameraTrackBaseLogger::logConfig_ = {"CameraTrackBase",
    "camera_track_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> CameraTrackBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> CameraTrackBaseLogger::loggerCtxMap_;
std::mutex CameraTrackBaseLogger::ctxMapMutex_;
std::mutex CameraTrackBaseLogger::loggerCtxMapMutex_;

void CameraTrackBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void CameraTrackBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void CameraTrackBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* CameraTrackBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String CameraTrackBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> CameraTrackBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel CameraTrackBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode CameraTrackBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig CameraTrackBaseLogger::ParseLogConfig()
{
    ara::core::String filePath;
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "camera_track_base context",
...
bool CameraTrackBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool CameraTrackBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
