 ...
 */
#ifndef ARA_FRONTCAMERATRACKER_FRONTCAMERATRACKER_LOGGER_H
#define ARA_FRONTCAMERATRACKER_FRONTCAMERATRACKER_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class FrontcameratrackerLogger {
public:
    virtual ~FrontcameratrackerLogger() = default;
     ...
     * ara::frontcameratracker::FrontcameratrackerLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    FrontcameratrackerLogger() = default;
...
#endif  /* ARA_FRONTCAMERATRACKER_FRONTCAMERATRACKER_LOGGER_H */