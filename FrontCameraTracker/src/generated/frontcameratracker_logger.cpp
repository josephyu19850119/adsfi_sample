...
LogConfig FrontcameratrackerLogger::logConfig_ = {"Frontcameratracker",
    "FrontCameraTracker context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> FrontcameratrackerLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> FrontcameratrackerLogger::loggerCtxMap_;
std::mutex FrontcameratrackerLogger::ctxMapMutex_;
std::mutex FrontcameratrackerLogger::loggerCtxMapMutex_;

void FrontcameratrackerLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void FrontcameratrackerLogger::InitAppLogging()
{
    SetLogConfig();
...
void FrontcameratrackerLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* FrontcameratrackerLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String FrontcameratrackerLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> FrontcameratrackerLogger::GetSpecifyLogMode(
...
ara::log::LogLevel FrontcameratrackerLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode FrontcameratrackerLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig FrontcameratrackerLogger::ParseLogConfig()
{
    ara::core::String filePath;
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "FrontCameraTracker context",
...
bool FrontcameratrackerLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool FrontcameratrackerLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
