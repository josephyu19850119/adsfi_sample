 ...
 */
#ifndef ARA_FRONTCAMERATRACKER2_FRONTCAMERATRACKER2_LOGGER_H
#define ARA_FRONTCAMERATRACKER2_FRONTCAMERATRACKER2_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class Frontcameratracker2Logger {
public:
    virtual ~Frontcameratracker2Logger() = default;
     ...
     * ara::frontcameratracker2::Frontcameratracker2Logger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    Frontcameratracker2Logger() = default;
...
#endif  /* ARA_FRONTCAMERATRACKER2_FRONTCAMERATRACKER2_LOGGER_H */