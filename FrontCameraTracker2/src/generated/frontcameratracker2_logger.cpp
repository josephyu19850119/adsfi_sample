...
LogConfig Frontcameratracker2Logger::logConfig_ = {"Frontcameratracker2",
    "FrontCameraTracker2 context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Frontcameratracker2Logger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Frontcameratracker2Logger::loggerCtxMap_;
std::mutex Frontcameratracker2Logger::ctxMapMutex_;
std::mutex Frontcameratracker2Logger::loggerCtxMapMutex_;

void Frontcameratracker2Logger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void Frontcameratracker2Logger::InitAppLogging()
{
    SetLogConfig();
...
void Frontcameratracker2Logger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Frontcameratracker2Logger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Frontcameratracker2Logger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Frontcameratracker2Logger::GetSpecifyLogMode(
...
ara::log::LogLevel Frontcameratracker2Logger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode Frontcameratracker2Logger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig Frontcameratracker2Logger::ParseLogConfig()
{
    ara::core::String filePath;
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "FrontCameraTracker2 context",
...
bool Frontcameratracker2Logger::DoesFileExist(const ara::core::String& filePath)
{
...
bool Frontcameratracker2Logger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
