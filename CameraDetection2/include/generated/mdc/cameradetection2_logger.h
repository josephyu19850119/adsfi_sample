 ...
 */
#ifndef ARA_CAMERADETECTION2_CAMERADETECTION2_LOGGER_H
#define ARA_CAMERADETECTION2_CAMERADETECTION2_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class Cameradetection2Logger {
public:
    virtual ~Cameradetection2Logger() = default;
     ...
     * ara::cameradetection2::Cameradetection2Logger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    Cameradetection2Logger() = default;
...
#endif  /* ARA_CAMERADETECTION2_CAMERADETECTION2_LOGGER_H */