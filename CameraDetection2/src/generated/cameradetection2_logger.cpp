...
LogConfig Cameradetection2Logger::logConfig_ = {"Cameradetection2",
    "CameraDetection2 context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Cameradetection2Logger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Cameradetection2Logger::loggerCtxMap_;
std::mutex Cameradetection2Logger::ctxMapMutex_;
std::mutex Cameradetection2Logger::loggerCtxMapMutex_;

void Cameradetection2Logger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void Cameradetection2Logger::InitAppLogging()
{
    SetLogConfig();
...
void Cameradetection2Logger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Cameradetection2Logger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Cameradetection2Logger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Cameradetection2Logger::GetSpecifyLogMode(
...
ara::log::LogLevel Cameradetection2Logger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode Cameradetection2Logger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig Cameradetection2Logger::ParseLogConfig()
{
    ara::core::String filePath;
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "CameraDetection2 context",
...
bool Cameradetection2Logger::DoesFileExist(const ara::core::String& filePath)
{
...
bool Cameradetection2Logger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
